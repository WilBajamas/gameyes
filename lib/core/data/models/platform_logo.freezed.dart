...
$PlatformLogoCopyWith<PlatformLogo> get copyWith => _$PlatformLogoCopyWithImpl<PlatformLogo>(this as PlatformLogo, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is PlatformLogo&&(identical(other.url, url) || other.url == url));
}
...
abstract mixin class $PlatformLogoCopyWith<$Res>  {
  factory $PlatformLogoCopyWith(PlatformLogo value, $Res Function(PlatformLogo) _then) = _$PlatformLogoCopyWithImpl;
@useResult
$Res call({
 String? url
});
...
/// @nodoc
class _$PlatformLogoCopyWithImpl<$Res>
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PlatformLogo value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PlatformLogo value)  $default,){
final _that = this;
switch (_that) {
case _PlatformLogo():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PlatformLogo value)?  $default,){
final _that = this;
switch (_that) {
case _PlatformLogo() when $default != null:
return $default(_that);case _:
...
class _PlatformLogo extends PlatformLogo {
  ...
  factory _PlatformLogo.fromJson(Map<String, dynamic> json) => _$PlatformLogoFromJson(json);
...
@pragma('vm:prefer-inline')
_$PlatformLogoCopyWith<_PlatformLogo> get copyWith => __$PlatformLogoCopyWithImpl<_PlatformLogo>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PlatformLogoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PlatformLogo&&(identical(other.url, url) || other.url == url));
}
...
/// @nodoc
abstract mixin class _$PlatformLogoCopyWith<$Res> implements $PlatformLogoCopyWith<$Res> {
  factory _$PlatformLogoCopyWith(_PlatformLogo value, $Res Function(_PlatformLogo) _then) = __$PlatformLogoCopyWithImpl;
@override @useResult
$Res call({
 String? url
});
