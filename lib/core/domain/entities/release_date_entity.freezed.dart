...
mixin _$ReleaseDateEntity {
  ...
  $ReleaseDateEntityCopyWith<ReleaseDateEntity> get copyWith =>
      _$ReleaseDateEntityCopyWithImpl<ReleaseDateEntity>(
          this as ReleaseDateEntity, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ReleaseDateEntity &&
...
abstract mixin class $ReleaseDateEntityCopyWith<$Res> {
  factory $ReleaseDateEntityCopyWith(
          ReleaseDateEntity value, $Res Function(ReleaseDateEntity) _then) =
      _$ReleaseDateEntityCopyWithImpl;
  @useResult
  $Res call({DateTime date, String human});
}
...
extension ReleaseDateEntityPatterns on ReleaseDateEntity {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ReleaseDateEntity value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(DateTime date, String human)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _ReleaseDateEntity implements ReleaseDateEntity {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ReleaseDateEntityCopyWith<_ReleaseDateEntity> get copyWith =>
      __$ReleaseDateEntityCopyWithImpl<_ReleaseDateEntity>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ReleaseDateEntity &&
            (identical(other.date, date) || other.date == date) &&
            (identical(other.human, human) || other.human == human));
  }
...
/// @nodoc
abstract mixin class _$ReleaseDateEntityCopyWith<$Res>
    implements $ReleaseDateEntityCopyWith<$Res> {
  factory _$ReleaseDateEntityCopyWith(
          _ReleaseDateEntity value, $Res Function(_ReleaseDateEntity) _then) =
      __$ReleaseDateEntityCopyWithImpl;
  @override
  @useResult
  $Res call({DateTime date, String human});
}
