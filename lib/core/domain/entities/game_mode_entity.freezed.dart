...
mixin _$GameModeEntity {
  ...
  $GameModeEntityCopyWith<GameModeEntity> get copyWith =>
      _$GameModeEntityCopyWithImpl<GameModeEntity>(
          this as GameModeEntity, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is GameModeEntity &&
...
abstract mixin class $GameModeEntityCopyWith<$Res> {
  factory $GameModeEntityCopyWith(
          GameModeEntity value, $Res Function(GameModeEntity) _then) =
      _$GameModeEntityCopyWithImpl;
  @useResult
...
extension GameModeEntityPatterns on GameModeEntity {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_GameModeEntity value)? $default, {
...
class _GameModeEntity implements GameModeEntity {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$GameModeEntityCopyWith<_GameModeEntity> get copyWith =>
      __$GameModeEntityCopyWithImpl<_GameModeEntity>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _GameModeEntity &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.name, name) || other.name == name));
  }
...
/// @nodoc
abstract mixin class _$GameModeEntityCopyWith<$Res>
    implements $GameModeEntityCopyWith<$Res> {
  factory _$GameModeEntityCopyWith(
          _GameModeEntity value, $Res Function(_GameModeEntity) _then) =
      __$GameModeEntityCopyWithImpl;
  @override
  @useResult
  $Res call({int id, String name});
}
