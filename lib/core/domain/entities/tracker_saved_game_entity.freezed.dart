...
$TrackerSavedGameEntityCopyWith<TrackerSavedGameEntity> get copyWith => _$TrackerSavedGameEntityCopyWithImpl<TrackerSavedGameEntity>(this as TrackerSavedGameEntity, _$identity);
...
as int?,gameSlug: freezed == gameSlug ? _self.gameSlug : gameSlug // ignore: cast_nullable_to_non_nullable
as String?,dateSaved: freezed == dateSaved ? _self.dateSaved : dateSaved // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TrackerSavedGameEntity value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TrackerSavedGameEntity value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TrackerSavedGameEntity value)?  $default,){
final _that = this;
switch (_that) {
case _TrackerSavedGameEntity() when $default != null:
return $default(_that);case _:
...
@override final  String? gameSlug;
@override final  DateTime? dateSaved;
...
@override List<PlatformEntity>? get availablePlatforms {
  final value = _availablePlatforms;
  if (value == null) return null;
  if (_availablePlatforms is EqualUnmodifiableListView) return _availablePlatforms;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(value);
}
...
@pragma('vm:prefer-inline')
_$TrackerSavedGameEntityCopyWith<_TrackerSavedGameEntity> get copyWith => __$TrackerSavedGameEntityCopyWithImpl<_TrackerSavedGameEntity>(this, _$identity);
...
/// @nodoc
abstract mixin class _$TrackerSavedGameEntityCopyWith<$Res> implements $TrackerSavedGameEntityCopyWith<$Res> {
