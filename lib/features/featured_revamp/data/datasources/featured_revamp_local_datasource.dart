...
@injectable
class FeaturedRevampLocalDatasource {
  final GameLocalStorageService _localStorage;
  final SharedPreferences _sharedPreferences;

  static const _genreIdsKey = 'featured_revamp_genre_ids';
  static const _skippedKey = 'featured_revamp_genre_skipped';

  FeaturedRevampLocalDatasource(
    this._localStorage,
