...
@Injectable(as: FeaturedRevampRepository)
class FeaturedRevampRepositoryImpl
    with BaseRepositoryMixin
    implements FeaturedRevampRepository {
  final FeaturedRevampLocalDatasource _localDatasource;
  ...
  Future<Result<LibrarySnapshotEntity>> getLibrarySnapshot() async {
    try {
      ...
      debugPrint(
        'Featured Revamp Repository getLibrarySnapshot $e | stacktrace: $stacktrace',
      );
  ...
  Future<Result<GameEntity?>> getCountdownGame() async {
    try {
      ...
      debugPrint(
        'Featured Revamp Repository getCountdownGame $e | stacktrace: $stacktrace',
      );
      return Failure(const ErrorType.unknown());
    }
  }
  ...
  Future<Result<List<GameEntity>>> getOutThisWeekGames(
    ...
    try {
      ...
      debugPrint(
        'Featured Revamp Repository getOutThisWeekGames $e | stacktrace: $stacktrace',
      );
      return Failure(const ErrorType.unknown());
    }
  }
  ...
  Future<Result<List<GameEntity>>> getCriticsChoiceGames(
    ...
    try {
      ...
      debugPrint(
          'Featured Revamp Repository getCriticsChoiceGames $e | stacktrace: $stacktrace');
      return Failure(const ErrorType.unknown());
    }
  }
  ...
  Future<Result<void>> saveGenrePreferences(
    ...
    try {
      ...
      debugPrint(
          'Featured Revamp Repository saveGenrePreferences $e | stacktrace: $stacktrace');
      return Failure(const ErrorType.unknown());
    }
  }
  ...
  Future<Result<GenrePreferencesEntity>> getGenrePreferences() async {
    try {
      ...
      debugPrint(
          'Featured Revamp Repository Impl getGenrePreferences $e | stacktrace: $stacktrace');
      return Failure(const ErrorType.unknown());
    }
  }
}
