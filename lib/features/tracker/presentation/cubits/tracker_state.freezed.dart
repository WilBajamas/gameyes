...
mixin _$TrackerState {
 ...
 SavedGameFilterTag get tag; String? get searchTerm;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TrackerState&&(identical(other.tag, tag) || other.tag == tag)&&(identical(other.searchTerm, searchTerm) || other.searchTerm == searchTerm));
}
...
@useResult
$Res call({
 SavedGameFilterTag tag, String? searchTerm
});
...
/// Create a copy of TrackerState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? tag = null,Object? searchTerm = freezed,}) {
  return _then(_self.copyWith(
tag: null == tag ? _self.tag : tag // ignore: cast_nullable_to_non_nullable
as SavedGameFilterTag,searchTerm: freezed == searchTerm ? _self.searchTerm : searchTerm // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( SavedGameFilterTag tag,  String? searchTerm)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TrackerState() when $default != null:
return $default(_that.tag,_that.searchTerm);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( SavedGameFilterTag tag,  String? searchTerm)  $default,) {final _that = this;
switch (_that) {
case _TrackerState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( SavedGameFilterTag tag,  String? searchTerm)?  $default,) {final _that = this;
switch (_that) {
case _TrackerState() when $default != null:
return $default(_that.tag,_that.searchTerm);case _:
  return null;
...
class _TrackerState implements TrackerState {
  const _TrackerState({this.tag = SavedGameFilterTag.recentlyChanged, this.searchTerm});
  

@override@JsonKey() final  SavedGameFilterTag tag;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TrackerState&&(identical(other.tag, tag) || other.tag == tag)&&(identical(other.searchTerm, searchTerm) || other.searchTerm == searchTerm));
}
...
/// Create a copy of TrackerState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? tag = null,Object? searchTerm = freezed,}) {
