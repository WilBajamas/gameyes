...
mixin _$ScreenshotResponseModel {
  ...
  $ScreenshotResponseModelCopyWith<ScreenshotResponseModel> get copyWith =>
      _$ScreenshotResponseModelCopyWithImpl<ScreenshotResponseModel>(
          this as ScreenshotResponseModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ScreenshotResponseModel &&
...
abstract mixin class $ScreenshotResponseModelCopyWith<$Res> {
  factory $ScreenshotResponseModelCopyWith(ScreenshotResponseModel value,
          $Res Function(ScreenshotResponseModel) _then) =
      _$ScreenshotResponseModelCopyWithImpl;
  @useResult
...
extension ScreenshotResponseModelPatterns on ScreenshotResponseModel {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_ScreenshotResponseModel value)? $default, {
...
class _ScreenshotResponseModel extends ScreenshotResponseModel {
  const _ScreenshotResponseModel({required final List<Screenshot> results})
      : _results = results,
        super._();
  factory _ScreenshotResponseModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ScreenshotResponseModelCopyWith<_ScreenshotResponseModel> get copyWith =>
      __$ScreenshotResponseModelCopyWithImpl<_ScreenshotResponseModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ScreenshotResponseModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ScreenshotResponseModel &&
...
/// @nodoc
abstract mixin class _$ScreenshotResponseModelCopyWith<$Res>
    implements $ScreenshotResponseModelCopyWith<$Res> {
  factory _$ScreenshotResponseModelCopyWith(_ScreenshotResponseModel value,
          $Res Function(_ScreenshotResponseModel) _then) =
      __$ScreenshotResponseModelCopyWithImpl;
  @override
  @useResult
  $Res call({List<Screenshot> results});
}
